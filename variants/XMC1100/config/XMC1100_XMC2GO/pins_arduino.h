...
const XMC_PORT_PIN_t mapping_port_pin[] =
{
    ...
    /* 4  */    {XMC_GPIO_PORT0 , 14},  // TX / GPIO                        P0.14
    /* 5  */    {XMC_GPIO_PORT0 , 15},  // RX / GPIO                           P0.15
    /* 6  */    {XMC_GPIO_PORT2 , 0},   // TX   / DIR (Fixed on PCB)                            P2.0
    /* 7  */    {XMC_GPIO_PORT2 , 6},   // RX   / GPIO                            P2.6 (INPUT ONLY)
    /* 8  */    {XMC_GPIO_PORT0 , 5},   // PWM40-0 output                   P0.5
    /* 9  */    {XMC_GPIO_PORT0 , 0},   // External interrupt 0             P0.0
    /* 10  */   {XMC_GPIO_PORT2 , 11},  // I2C Clock SCL / A3 ADC / DIS  (Fixed on PCB)           P2.11
    /* 11  */   {XMC_GPIO_PORT2 , 10},  // I2C Data / Address SDA / A2 ADC / PWM / PWM1 output (Fixed on PCB) P2.10
...
const uint8_t NUM_PWM2  = ( sizeof( mapping_pwm4 ) / sizeof( XMC_PWM4_t ) );
